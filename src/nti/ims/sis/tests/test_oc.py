...
class TestOSU(unittest.TestCase):
    ...
    def _parse_1(self, source):
        ...
        assert_that(p,
                    has_property('sourcedid', has_property('id', is_('1004596'))))
        ...
        assert_that(group,
                    has_property('description', is_('Software Engr - Introduction 2015FA')))
        assert_that(group,
                    has_property('sourcedid', has_property('source', is_('SIS'))))
        assert_that(group,
        ...
        assert_that(member,
                    has_property('sourcedid', has_property('source', is_('SIS'))))
        assert_that(member,
                    has_property('sourcedid', has_property('id', is_('1328493'))))
        assert_that(member,
                    has_property('role', has_property('roletype', is_('01'))))
        assert_that(member,
                    has_property('role', has_property('status', is_(1))))
        assert_that(member,
                    has_property('role', has_property('userid', is_('drew.knoles'))))
    ...
    def _parse_2(self, source):
        ...
        assert_that(member,
                    has_property('role', has_property('status', is_(1))))
        assert_that(member,
                    has_property('role', has_property('userid', is_('drew.knoles@eagles.oc.edu'))))
