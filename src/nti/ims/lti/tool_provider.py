...
from outcome_service import OutcomeRequest
...
class ToolProvider(LaunchParamsMixin, object):
    ...
    def new_request(self, defaults, service_type):
        ...
        """
        self.outcome_requests.append(OutcomeRequest( self.consumer_key,self.consumer_secret,
          self.lis_outcome_service_url, self.lis_result_sourcedid,service_type, self.message_identifier,
           self.imsx_version, self.language))
